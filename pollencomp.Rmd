...
vigornames <- c(hybrid.vigor.germsurv="Relative hybrid fitness", prop.hybrid="Surviving hybrids", prop.hybrid.sds = "Hybrid seeds")
...
hybrid.phylostyle %>% pivot_longer(c(pd, style_length_mm), names_to = "xname", values_to = "xvalue") %>% 
  ...
  scale_y_continuous(expand=expansion(mult=c(0,0.05))) + expand_limits(y=0) +
  ...
  theme(axis.text=element_text(color="black"), legend.position="top", panel.background = element_rect(),
        ...
        panel.spacing = unit(0.5,"lines"), panel.grid = element_blank()) 
