...
```{r inflotraits, fig.width=4.5, fig.height=8}
inflotraits <- c("inflo", "inflo.biomass.g.inflo", "flower.number.inflo")
inflobiomass.sum %>% 
  ...
  facet_wrap(vars(name), ncol=1, scales="free_y", strip.position="left",
             labeller = as_labeller(c(inflo="Inflorescences", 
                                      inflo.biomass.g.inflo="Biomass per inflorescence (g)", 
